...
<!-- screenshot: openapi/editor-basics.png -->
![OpenAPI editor with a YAML spec open, showing syntax highlighting and inline diagnostics](/screenshots/openapi/editor-basics.png)
