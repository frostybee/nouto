  ...
  <div class="help-content">
    ...
    <section class="help-section">
      ...
      <div class="examples">
        ...
        <div class="example-group">
          <div class="example-label">Regex — anchored match</div>
          <code class="example-code">name ~ "^The"</code>
          <span class="example-desc">Items where name starts with "The"</span>
        </div>

        <div class="example-group">
          <div class="example-label">Regex — ends with pattern</div>
          <code class="example-code">url ~ "\.json$"</code>
          <span class="example-desc">Items where url ends with ".json"</span>
        </div>

        <div class="example-group">
          <div class="example-label">Regex — alternation</div>
          <code class="example-code">status ~ "^(Ended|Canceled)$"</code>
          <span class="example-desc">Items where status is exactly "Ended" or "Canceled"</span>
        </div>

        <div class="example-group">
          <div class="example-label">Regex — digits only</div>
          <code class="example-code">code ~ "^\d&#123;3,5&#125;$"</code>
          <span class="example-desc">Items where code is 3 to 5 digits</span>
        </div>

        <div class="example-group">
          <div class="example-label">Regex — combined with AND</div>
          <code class="example-code">name ~ "^[A-M]" AND type = "Scripted"</code>
          <span class="example-desc">Scripted items whose name begins with A through M</span>
        </div>
    ...
    <section class="help-section">
      ...
      <ul class="tips-list">
        ...
        <li><code>contains</code>, <code>startsWith</code>, <code>endsWith</code>, and <code>~</code> are case-insensitive</li>
        <li>Regex (<code>~</code>) supports any JavaScript regex: anchors <code>^ $</code>, groups <code>( )</code>, quantifiers <code>* + ? &#123;n&#125;</code>, character classes <code>[A-Z] \d \w</code></li>
