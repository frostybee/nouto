...
const gotoLineTheme = EditorView.baseTheme({
  '.cm-goto-line-panel': {
    ...
    padding: '6px 12px',
    borderBottom: '1px solid var(--hf-editorWidget-border)',
    backgroundColor: 'var(--hf-editorWidget-background)',
  },
  '.cm-goto-line-left': {
    display: 'flex',
    alignItems: 'center',
  ...
  '.cm-goto-line-label': {
    ...
    fontWeight: '500',
    whiteSpace: 'nowrap',
    color: 'var(--hf-editorWidget-foreground)',
  },
  ...
  '.cm-goto-line-input-wrap:focus-within': {
    borderColor: 'var(--hf-focusBorder)',
    outline: 'none',
  },
  '.cm-goto-line-input': {
    width: '120px',
    padding: '4px 8px !important',
    backgroundColor: 'var(--hf-input-background) !important',
    color: 'var(--hf-input-foreground) !important',
    border: 'none !important',
    borderRadius: '0 !important',
    fontSize: '12px !important',
    fontFamily: 'var(--hf-editor-font-family) !important',
  ...
  '.cm-goto-line-input-error': {
    backgroundColor: 'var(--hf-inputValidation-errorBackground) !important',
  },
  '.cm-goto-line-btn': {
    padding: '4px 12px',
    backgroundColor: 'var(--hf-button-background)',
  ...
  '.cm-goto-line-btn:hover': {
    backgroundColor: 'var(--hf-button-hoverBackground)',
  },
  ...
  '.cm-goto-line-close:hover': {
    opacity: '1',
    backgroundColor: 'var(--hf-toolbar-hoverBackground) !important',
  },
});
