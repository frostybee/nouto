...
export interface IPanelContext {
  ...
  readonly sidebarProvider: {
    ...
    updateRequestResponse(requestId: string, collectionId: string, status: number, duration: number, sentUrl?: string, sentMethod?: string, size?: number): Promise<void>;
  ...
  refreshJsonExplorer?(panelId: string, json: any, contentType?: string, meta?: { method?: string; url?: string; name?: string }): void;
}
