...
const IS_XHTML = ((_b = (_a = globalThis.document) == null ? void 0 : _a.contentType) == null ? void 0 : /* @__PURE__ */ _b.includes("xml")) ?? false;
...
const policy = (_d = (_c = globalThis == null ? void 0 : globalThis.window) == null ? void 0 : _c.trustedTypes) == null ? void 0 : /* @__PURE__ */ _d.createPolicy(
  "svelte-trusted-html",
  {
    /** @param {string} html */
    createHTML: (html) => {
...
function reconcile(state2, array, anchor, flags2, get_key) {
  ...
  for (i = 0; i < length; i += 1) {
    ...
    if ((effect2.f & INERT) !== 0) {
      ...
      if (is_animated) {
        (_d2 = (_c2 = effect2.nodes) == null ? void 0 : _c2.a) == null ? void 0 : _d2.unfix();
  ...
  if (state2.outrogroups !== null) {
    for (const group of state2.outrogroups) {
      if (group.pending.size === 0) {
        destroy_effects(array_from(group.done));
        (_e2 = state2.outrogroups) == null ? void 0 : _e2.delete(group);
      }
    }
...
if (typeof window !== "undefined") {
  ((_e = window.__svelte ?? (window.__svelte = {})).v ?? (_e.v = /* @__PURE__ */ new Set())).add(PUBLIC_VERSION);
}
export {
  $window as $,
  each as A,
  ...
  listen_to_event_and_reset_event as P,
  current_batch as Q,
  untrack as R,
  render_effect as S,
  previous_batch as T,
  ...
  STATE_SYMBOL as W,
  get_descriptor as X,
  capture_store_binding as Y,
  props_invalid_value as Z,
  PROPS_IS_UPDATED as _,
  delegate as a,
  is_destroying_effect as a0,
  active_effect as a1,
  DESTROYED as a2,
  PROPS_IS_BINDABLE as a3,
  PROPS_IS_IMMUTABLE as a4,
  derived$1 as a5,
  derived_safe_equal as a6,
  PROPS_IS_LAZY_INITIAL as a7,
  LEGACY_PROPS as a8,
  component_context as a9,
  teardown as aa,
  is_array as ab,
  select_multiple_invalid_value as ac,
  is as ad,
  to_style as ae,
  block as b,
  delegated as c,
...
//# sourceMappingURL=theme-U7NfCYzD.js.map
