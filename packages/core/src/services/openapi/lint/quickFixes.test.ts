...
describe('planLintQuickFix', () => {
  it('lists exactly the rules that have a fix', () => {
    expect([...LINT_FIXABLE_CODES].sort()).toEqual([
      ...
      'owasp-429-retry-after',
      'owasp-array-unbounded',
      'owasp-integer-no-format',
      'owasp-integer-unbounded',
      'owasp-jwt-best-practices',
      'owasp-response-401-missing',
      'owasp-response-429-missing',
      'owasp-response-500-missing',
      'owasp-string-unrestricted',
      'owasp-unsafe-operation-unprotected',
      'parameter-unbounded',
      'path-key-has-query',
