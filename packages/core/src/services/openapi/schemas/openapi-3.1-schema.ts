...
// Source: https://spec.openapis.org/oas/3.1/schema/2025-09-15 (see PROVENANCE.md)

/** OpenAPI 3.1.x meta-schema (JSON Schema 2020-12). Host-side Ajv2020 use only. */
export const openapi31MetaSchema: Record<string, unknown> = {
