...
// Source: https://spec.openapis.org/oas/3.2/schema/2025-09-17 (transformed) (see PROVENANCE.md)

/** OpenAPI 3.2.x meta-schema, editor variant: $dynamicRef/$dynamicAnchor rewritten to static refs for the in-editor draft-04-level validation pipeline. */
export const openapi32MetaSchemaEditor: Record<string, unknown> = {
  ...
  "$comment": "Nouto editor variant: $dynamicRef/$dynamicAnchor rewritten to static refs for draft-04-level validators. See PROVENANCE.md."
};
