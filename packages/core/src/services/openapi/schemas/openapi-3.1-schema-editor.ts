...
// Source: https://spec.openapis.org/oas/3.1/schema/2025-09-15 (transformed) (see PROVENANCE.md)

/** OpenAPI 3.1.x meta-schema, editor variant: $dynamicRef/$dynamicAnchor rewritten to static refs for the in-editor draft-04-level validation pipeline. */
export const openapi31MetaSchemaEditor: Record<string, unknown> = {
