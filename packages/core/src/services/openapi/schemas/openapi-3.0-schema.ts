...
// Source: https://spec.openapis.org/oas/3.0/schema/2024-10-18 (see PROVENANCE.md)

/** OpenAPI 3.0.x meta-schema (JSON Schema draft-04). */
export const openapi30MetaSchema: Record<string, unknown> = {
