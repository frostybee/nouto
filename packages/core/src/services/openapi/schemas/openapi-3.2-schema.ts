...
// Source: https://spec.openapis.org/oas/3.2/schema/2025-09-17 (see PROVENANCE.md)

/** OpenAPI 3.2.x meta-schema (JSON Schema 2020-12). Host-side Ajv2020 use only. */
export const openapi32MetaSchema: Record<string, unknown> = {
